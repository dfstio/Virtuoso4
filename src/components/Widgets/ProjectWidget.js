  ...
  return (
    <Widget styleName="gx-ch-capitalize gx-card-sm-px" extra={
      ...
      <div className="gx-text-center gx-pt-sm-3">
        <img className="gx-size-60 gx-mb-3" src="assets/images/widget/birds.png" alt='birds'/>

        <h2 className="gx-mb-3 gx-mb-sm-4">Eagal Hunt App</h2>

        <ul className="gx-list-inline gx-mb-3 gx-mb-lg-4">
          <li><Avatar src="assets/images/avatar/steve-smith.png"/></li>
          <li><Avatar src="assets/images/avatar/stella-johnson.png"/></li>
          <li><Avatar src="assets/images/avatar/domnic-harris.png"/></li>
